...
Answer: No, it will not. The product will arrive at the pickup location as a ready shipment and will simply be handed over to the customer. The inventory count will decrease at the original shipping facility, not at the pickup location.

<BR>

Q3: Is the number of days in ‘Pickup in two days’ dynamic depending upon the shipping time it would take to ship that order to the pickup location from the warehouse? 
<BR>

Answer: No, the "Pickup in Two Days" option will have a static number of days for all pickup locations without inventory. Retailers are responsible for sharing this static information regarding the approximate time required to ship the order to the pickup locations.
